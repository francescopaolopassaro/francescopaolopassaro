...
<img src="./c64.svg?v=2" alt="Commodore 64 Intro" width="100%" />
...
![CQRS](https://img.shields.io/badge/CQRS-1C3C3C?style=flat-square)
![Event-Driven](https://img.shields.io/badge/Event--Driven-1C3C3C?style=flat-square)
...
| Project | Description |
|---------|-------------|
| **Kodinn** | Multi-agent, multi-provider, multi-role AI orchestrator (local/cloud) with autonomous context management, hardware monitoring and custom connectors |
| [**Synthelion**](https://github.com/francescopaolopassaro/Synthelion) | Prompt-compression engine that runs before any AI model — cutting token usage by up to 70%, reducing API costs and speeding up responses. Works with Claude Code, OpenAI, LangChain, OpenCode, Cursor. 50+ languages, no AI model required, zero configuration |
| [**Caveman**](https://github.com/francescopaolopassaro/caveman) | C# library that reduces LLM prompt tokens by removing grammatical noise |
| [**Caveman.mcp**](https://github.com/francescopaolopassaro/Caveman.mcp) | Model Context Protocol server for token and prompt optimization |
...
| [**aspnetcore2mysqlidentitytemplate**](https://github.com/francescopaolopassaro/aspnetcore2mysqlidentitytemplate) | ASP.NET Core 2.0 template with Identity and WebAPI | ![.NET](https://img.shields.io/badge/-ASP.NET_Core-512BD4?style=flat-square&logo=dotnet&logoColor=white) |
